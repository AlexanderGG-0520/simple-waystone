...
execute as @e[type=minecraft:armor_stand,tag=sws.waystone,tag=sws.clickable,distance=..4,sort=nearest,limit=1] run scoreboard players operation #delete sws.tmp = @s sws.id
