...
$execute if score @s sws.tmp matches 1 run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Silent:1b,CustomName:{text:"$(name)",color:"aqua",italic:0b},CustomNameVisible:1b,Tags:["sws.waystone","sws.clickable","sws.pending"]}
