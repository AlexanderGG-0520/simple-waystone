...
$execute if score @s sws.has_cost matches 1 run summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Silent:1b,CustomName:$(name),CustomNameVisible:1b,Tags:["sws.waystone","sws.clickable","sws.pending"]}
...
execute if score @s sws.has_cost matches 1 run tellraw @s [{"text":"[Simple Waystone] ","color":"gold"},{"text":"Created waystone #","color":"green"},{"score":{"name":"#next","objective":"sws.id"},"color":"green"},{"text":".","color":"green"}]
