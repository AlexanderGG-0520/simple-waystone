...
execute if entity @e[type=minecraft:armor_stand,tag=sws.waystone,tag=sws.clickable,distance=..4,sort=nearest,limit=1] run function simple_waystone:teleport/to_nearest
