...
execute if score #core.lodestone sws.tmp matches 1.. if score #core.ender_eye sws.tmp matches 16.. if score #core.diamond_block sws.tmp matches 4.. run scoreboard players set @s sws.has_cost 1
